            ...
            <div class="row">
              <div class="col-xs-12">
                  ...
                  <div class="box box-info">
                      ...
                      <form class="form-horizontal" method="post" action="<?=site_url('barang/addbarang')?>">
                        <div class="box-body">
                          <div class="form-group">
                            <label for="id_barang" class="col-sm-2 control-label">ID Barang</label>
                              <div class="col-sm-10">
                              <input type="text"  class="form-control" value="<?=$kodebarang?>" name="id_barang" readonly>
                            </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            <label for="harga_barang" class="col-sm-2 control-label">Harga Barang</label>
                              ...
                              <input type="text"  id="harga_barang" class="form-control" name="harga_barang" value="<?=set_value('harga_barang')?>"> 
                            </div>
                          </div>
                        </div>
                        <!-- /.box-body -->
